...
const finalKey =
  supabaseAnonKey ||
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxibXRjY2ZuY25xZHNycnRzc3B0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM3OTcwMzQsImV4cCI6MjA3OTM3MzAzNH0.eUhOIwcCxFoqFysWMLpOhReXaVnyKfOVifiug_NTTSY';
...
export function hasValidSupabaseConfig(): boolean {
  ...
  console.log(
    '[ENV Debug] VITE_SUPABASE_ANON_KEY:',
  ...
  if (!isValid) {
    console.error('[ENV Debug] 환경 변수 검증 실패:', {
      ...
      message:
        '프로젝트 루트에 .env 파일을 생성하고 VITE_SUPABASE_URL과 VITE_SUPABASE_ANON_KEY를 설정해주세요.',
    });
  }
