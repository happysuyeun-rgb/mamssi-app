...
- [ ] 씨앗 이름 입력 (10자 이내)
- [ ] "시작하기" 버튼 클릭
- [ ] `users.onboarding_completed = true` 저장 확인
- [ ] `user_settings.seed_name` 저장 확인
...
- [ ] 씨앗 이름 입력 (1-10자)
- [ ] 저장 버튼 클릭
- [ ] `user_settings.seed_name` 업데이트 확인
- [ ] UI에 반영 확인
- [ ] 성공 토스트 메시지 확인

### 2.3 씨앗 이름 유효성 검사
- [ ] 빈 값 입력 시 경고 메시지 확인
- [ ] 10자 초과 입력 시 경고 메시지 확인
- [ ] 정상 값 입력 시 저장 성공 확인
...
- [ ] 저장 버튼 클릭
- [ ] 업로드 진행 상태 확인 (로딩 표시)
- [ ] Storage 버킷(`emotion-images`)에 저장 확인
- [ ] Public URL 생성 확인
- [ ] `emotions.image_url` 필드에 URL 저장 확인
- [ ] 성공 토스트 메시지 확인
- [ ] 홈 화면으로 리다이렉트 확인
...
- [ ] 이미지 파일 선택 (5MB 이하)
- [ ] 업로드 진행 확인
- [ ] Storage 버킷(`profile-images`)에 저장 확인
- [ ] Public URL 생성 확인
- [ ] `user_settings.profile_url` 업데이트 확인
- [ ] 프로필 이미지 표시 확인
- [ ] 성공 토스트 메시지 확인
...
- [ ] 기본 이모티콘으로 변경 버튼 클릭
- [ ] Storage에서 이미지 삭제 확인
- [ ] `user_settings.profile_url = null` 확인
- [ ] 기본 이모티콘 표시 확인
...
- [ ] 확인 다이얼로그 표시
- [ ] 탈퇴 확인
- [ ] `users.is_deleted = true` 확인
- [ ] `users.delete_reason` 저장 확인
- [ ] 알림 생성 확인
